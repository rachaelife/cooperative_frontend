...
function Building() {
  ...
  return (
    <DashboardLayout>
        ...
        <h1 className="my-5 text-3xl font-bold">Buillding and development</h1>

        <Button onClick={()=>setOPen(true)}><CgAdd /> New building & develoemnt</Button>
        <Modal open={open} footer={null} onCancel={()=>setOPen(false)}>
          <div className="mb-10">
              <h1 className="text-2xl text-slate-300">BUILDING AND DEVELOPMENT</h1>
          </div>
            <form className="">
